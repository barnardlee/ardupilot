...
# provide a marker for ArduPilot build options in threadX
CFLAGS    += -D_ARDUPILOT_

ifeq ($(ENABLE_ASSERTS),yes)
  ASXFLAGS += -DHAL_THREADX_ENABLE_ASSERTS
endif
...
$(ACPPOBJS) : $(OBJDIR)/%.o : %.cpp $(BUILDROOT)/threadx_flags.h
...
$(TCPPOBJS) : $(OBJDIR)/%.o : %.cpp $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ACOBJS) : $(OBJDIR)/%.o : %.c $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(TCOBJS) : $(OBJDIR)/%.o : %.c $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(LIBCC_TCOBJS) : $(OBJDIR)/%.o : %.c $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
	$(CC) -c $(CFLAGS) $(TOPT) -I. $(IINCDIR) $< -o $@
else
...
$(ASMOBJS) : $(OBJDIR)/%.o : %.s $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ASMXOBJS) : $(OBJDIR)/%.o : %.S $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(LIBCC_ASMXOBJS) : $(OBJDIR)/%.o : %.S $(BUILDROOT)/threadx_flags.h
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
